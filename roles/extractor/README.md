...
|-------|------|---------|------|
| Мой домен | PACK-my-domain | MD | /c/Users/pc/Github/PACK-my-domain/pack/my-domain/ |
```

### 2. (Опционально) Установи автоматический inbox-check

```bash
cd /c/Users/pc/Github/FMT-exocortex-template/roles/extractor
bash install.sh
```
...
bash /c/Users/pc/Github/FMT-exocortex-template/roles/extractor/scripts/extractor.sh inbox-check

# Knowledge Audit
bash /c/Users/pc/Github/FMT-exocortex-template/roles/extractor/scripts/extractor.sh audit
```
