...
|------------|-----------|-------|
| `gleniboutique` | GitHub username | setup.sh |
| `/c/Users/pc/Github` | Рабочая директория | setup.sh |
| `6` | Час запуска стратега (UTC) | setup.sh |
| `7:00 CET` | Описание времени | setup.sh |
| `/c/Users/pc/AppData/Roaming/npm/claude` | Путь к Claude CLI | setup.sh |
| `/c/Users/pc` | Домашняя директория | setup.sh |
| `-c-Users-pc-Github` | Slug проекта Claude | setup.sh |
